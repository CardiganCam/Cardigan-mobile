...
!function(a) {
    ...
    return function b(a, c, d) {
        ...
        49: [function(a, b) {
            "use strict";
            var c = Object.prototype.hasOwnProperty, d = Object.prototype.toString, e = Array.prototype.slice, f = a("./isArguments"), g=!{
                toString: null
            }.propertyIsEnumerable("toString"), h = function() {}.propertyIsEnumerable("prototype"), i = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"], j = function(a) {
                var b = a.constructor;
        ...
        55: [function(a, b) {
            ...
            function g(a) {
                ...
                var i = {
                    body: void 0,
                    headers: {}, statusCode : 0, method : q, url : p, rawRequest : k
                }, k = a.xhr || null;
            ...
            b.exports = f, f.XMLHttpRequest = i.XMLHttpRequest || h, f.XDomainRequest = "withCredentials"in new f.XMLHttpRequest ? f.XMLHttpRequest: i.XDomainRequest, c(["get", "put", "post", "patch", "head", "delete"],
            function(a) {
            ...
            var h = a("../component.js"), i = e(h), j = a("../utils/dom.js"), k = d(j), l = a("../utils/fn.js"), m = d(l), n = a("../utils/events.js"), o = d(n), p = function(a) {
                ...
                return g(b, a), b.prototype.addItem = function(a) {
                    ...
                    var a = arguments.length <= 0 || void 0 === arguments[0] ? 0 : arguments[0], b = this.children();
            ...
            var h = a("./component.js"), i = e(h), j = a("global/document"), k = e(j), l = a("global/window"), m = e(l), n = a("./utils/events.js"), o = d(n), p = a("./utils/dom.js"), q = d(p), r = a("./utils/fn.js"), s = d(r), t = a("./utils/guid.js"), u = d(t), v = a("./utils/browser.js"), w = (d(v), a("./utils/log.js")), x = e(w), y = a("./utils/to-title-case.js"), z = e(y), A = a("./utils/time-ranges.js"), B = a("./utils/buffer.js"), C = a("./utils/stylesheet.js"), D = d(C), E = a("./fullscreen-api.js"), F = e(E), G = a("./media-error.js"), H = e(G), I = a("safe-json-parse/tuple"), J = e(I), K = a("object.assign"), L = e(K), M = a("./utils/merge-options.js"), N = e(M), O = a("./tracks/text-track-list-converter.js"), P = e(O), Q = a("./tech/loader.js"), R = (e(Q), a("./poster-image.js")), S = (e(R), a("./tracks/text-track-display.js")), T = (e(S), a("./loading-spinner.js")), U = (e(T), a("./big-play-button.js")), V = (e(U), a("./control-bar/control-bar.js")), W = (e(V), a("./error-display.js")), X = (e(W), a("./tracks/text-track-settings.js")), Y = (e(X), a("./modal-dialog")), Z = e(Y), $ = a("./tech/tech.js"), _ = e($), aa = a("./tech/html5.js"), ba = (e(aa), function(a) {
                function b(c, d, e) {
                    var g = this;
                    if (f(this, b), c.id = c.id || "vjs_video_" + u.newGUID(), d = L["default"](b.getTagSettings(c), d), d.initChildren=!1, d.createEl=!1, d.reportTouchActivity=!1, a.call(this, null, d, e), !this.options_ ||!this.options_.techOrder ||!this.options_.techOrder.length)
                ...
                return g(b, a), b.prototype.dispose = function() {
                    ...
                    if ("" === b)
                        ...
                        var d = parseFloat(b);
                        if (isNaN(d))
                            return x["default"].error('Improper value "' + b + '" supplied for for ' + a), this;
                        this[c] = d
                    }
                    ...
                    var b = {
                        sources: [],
                        tracks: []
                    }, c = q.getElAttributes(a), d = c["data-setup"];
                    if (null !== d) {
            ...
            z.isSupported = function() {
                ...
                var e = z.getEmbedCode(a, b, c, d), f = m.createEl("div", {
                    innerHTML: e
                }).childNodes[0];
                return f
            ...
            var h = a("./tech.js"), i = e(h), j = a("../component"), k = e(j), l = a("../utils/dom.js"), m = d(l), n = a("../utils/url.js"), o = d(n), p = a("../utils/fn.js"), q = d(p), r = a("../utils/log.js"), s = e(r), t = a("../utils/browser.js"), u = d(t), v = a("global/document"), w = e(v), x = a("global/window"), y = e(x), z = a("object.assign"), A = e(z), B = a("../utils/merge-options.js"), C = e(B), D = function(a) {
                ...
                b.prototype.autoplay = function() {
                    ...
                    for (this.remoteTextTrackEls().removeTrackElement_(e), this.remoteTextTracks().removeTrack_(b), c = this.$$("track"), d = c.length; d--;)(b === c[d] || b === c[d].track) 
            ...
            function f(a) {
                ...
                if (h.IS_IE8) {
                    ...
                    for (var c in f.prototype)
                        "constructor" !== c && (b[c] = f.prototype[c])
                }
                return f.prototype.setCues_.call(b, a), Object.defineProperty(b, "length", {
                    get: function() {
                        return this.length_
                    }
                }), h.IS_IE8 ? b : void 0
            ...
            c.__esModule=!0;
            var g = a("../utils/browser.js"), h = e(g), i = a("global/document"), j = d(i);
            ...
            c.__esModule=!0;
            var g = a("../event-target"), h = e(g), i = a("../utils/fn.js"), j = d(i), k = a("../utils/browser.js"), l = d(k), m = a("global/document"), n = e(m);
            f.prototype = Object.create(h["default"].prototype), f.prototype.constructor = f, f.prototype.allowedEvents_ = {
                change: "change",
                addtrack: "addtrack",
            ...
            f.prototype.addTrack_ = function(a) {
                ...
                }), a.addEventListener("modechange", j.bind(this, function() {
                    this.trigger("change")
            ...
            function f() {
                ...
                b.tech_ = a.tech;
                var d = p.TextTrackMode[a.mode] || "disabled", e = p.TextTrackKind[a.kind] || "subtitles", g = a.label || "", i = a.language || a.srclang || "", k = a.id || "vjs_text_track_" + l.newGUID();
                ("metadata" === e || "chapters" === e) && (d = "hidden"), b.cues_ = [], b.activeCues_ = [];
                var m = new h["default"](b.cues_), o = new h["default"](b.activeCues_), q=!1, r = j.bind(b, function() {
                    this.activeCues, q && (this.trigger("cuechange"), q=!1)
                });
                return "disabled" !== d && b.tech_.on("timeupdate", r), Object.defineProperty(b, "kind", {
                    get: function() {
                        return e
                    },
                    ...
                    get: function() {
                        ...
                        if (q=!1, b.length !== this.activeCues_.length)
                            q=!0;
                        else 
                            for (var c = 0; c < b.length; c++) 
                                - 1 === D.call(this.activeCues_, b[c]) && (q=!0);
                        return this.activeCues_ = b, o.setCues_(this.activeCues_), o
                    },
                    set: Function.prototype
                }), a.src ? (b.src = a.src, C(a.src, b)) : b.loaded_=!0, n.IS_IE8 ? b : void 0
            }
            c.__esModule=!0;
            var g = a("./text-track-cue-list"), h = e(g), i = a("../utils/fn.js"), j = d(i), k = a("../utils/guid.js"), l = d(k), m = a("../utils/browser.js"), n = d(m), o = a("./text-track-enums"), p = d(o), q = a("../utils/log.js"), r = e(q), s = a("../event-target"), t = e(s), u = a("global/document"), v = e(u), w = a("global/window"), x = e(w), y = a("../utils/url.js"), z = a("xhr"), A = e(z);
            f.prototype = Object.create(t["default"].prototype), f.prototype.constructor = f, f.prototype.allowedEvents_ = {
                cuechange: "cuechange"
            ...
            var B = function(a, b) {
                ...
                d && (c.cors = d), A["default"](c, j.bind(this, function(a, c, d) {
            ...
            function e(a, b) {
                var c = Array.prototype.slice.call(b), d = function() {}, e = g["default"].console || {
                    log: d,
                    warn: d,
                    error: d
                };
            ...
            j.autoSetupTimeout(1, $), $.VERSION = "5.8.0", $.options = t["default"].prototype.options_, $.getPlayers = function() {
